...
class InventoryManagementSystem:
   ...
   # main.py (excerpt)
            ...
            while True:
                ...
                if user.role == "Admin":
                    ...
                    if choice == "1":
                        ...
                        kwargs = {k: v for k, v in [("name", name), ("category", category), ("price", price), ("stock_quantity", stock_quantity)] if v}
    ...
    def buy_product(self):
        """Handles the buying process for a user."""
        product_id = input("Enter the Product ID to buy: ")
        product = self.products.get(product_id)
